                ...
                <>
                  ...
                  {hasMore ? (
                    ...
                    <div className="text-center py-16 relative overflow-hidden">
                       ...
                       <p className={`relative z-10 text-[11px] font-black uppercase tracking-[0.5em] bg-transparent inline-block px-8 py-2 ${darkMode ? "text-blue-200" : "text-blue-900"}`}>
                         ✨ <span className={darkMode ? "text-blue-100" : "text-blue-950"}>You have reached the end of the feed</span> ✨
                       </p>
                    </div>
                  )}
                </>
