  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm overflow-y-auto">
      <div className={`p-[2px] rounded-[2.6rem] bg-gradient-to-tr from-blue-500 to-purple-600 w-full max-w-2xl my-auto shadow-2xl transition-all`}>
        <div className={`relative w-full h-full ${darkMode ? "bg-slate-900" : "bg-white"} rounded-[2.5rem] overflow-hidden`}>
        {/* Header */}
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-8 max-h-[70vh] overflow-y-auto custom-scrollbar">
          ...
          <div className="space-y-4">
            <div className="p-[2px] rounded-3xl bg-gradient-to-r from-blue-500 to-purple-500">
              <div className={`p-6 border-2 border-dashed border-transparent ${darkMode ? "bg-slate-900" : "bg-white"} rounded-[1.7rem] text-center`}>
            ...
            <div className="md:col-span-2 space-y-2">
              ...
              <div className={getErrorClass("title")}>
                <input
                  ...
                  className={`w-full p-4 rounded-[14px] ${darkMode ? "bg-slate-900 text-white" : "bg-white text-black"} outline-none border-none`}
                />
              </div>
            </div>
          ...
          <div className="space-y-2">
            ...
            <div className={getErrorClass("description")}>
              <textarea
                ...
                className={`w-full p-4 rounded-[14px] ${darkMode ? "bg-slate-900 text-white" : "bg-white text-black"} outline-none border-none resize-none`}
              />
            </div>
          </div>
          ...
          <div className="p-[2px] rounded-[2rem] bg-gradient-to-r from-blue-500 to-purple-500 shadow-sm transition-all text-left">
            <div className={`p-6 rounded-[1.8rem] ${darkMode ? "bg-slate-900" : "bg-white"} space-y-6`}>
