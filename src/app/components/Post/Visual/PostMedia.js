          ...
          {post.documents.map((doc, index) => (
            <div key={index} className="flex gap-2 w-full sm:w-auto">
              <button
                ...
                className={`flex items-center justify-between p-3 rounded-xl border ${darkMode ? "bg-[#1a1a1c] border-white/10 hover:bg-white/5" : "bg-white border-gray-200 hover:bg-gray-50"} shadow-sm transition-colors w-full`}
              >
