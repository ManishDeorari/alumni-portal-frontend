                ...
                faculty.length > 0 && (
                  <div className="flex gap-3">
                    ...
                    <button
                      ...
                      className="px-6 py-2.5 bg-[#FAFAFA]/5 hover:bg-red-500/20 text-red-300 rounded-2xl text-sm font-black border border-white/10 transition-all disabled:opacity-30"
                    >
                      Reject
                    </button>
                  </div>
